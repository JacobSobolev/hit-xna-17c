...
{
    public class SpriteLabel : LoadableDrawableComponent
    {
        ...
        public Vector2 TextCenter
        {
            get
            {
                Vector2 CenterTextVec = new Vector2(SpriteFont.MeasureString(Text).X * Scales.X / 2, SpriteFont.MeasureString(Text).Y * Scales.Y / 2);
                return CenterTextVec;
            }
        }
        ...
        public SpriteLabel(string i_AssetName, Game i_Game, int i_UpdateOrder, int i_DrawOrder)
            : base(i_AssetName, i_Game, i_UpdateOrder, i_DrawOrder)
        { }

        public SpriteLabel(string i_AssetName, Game i_Game, int i_CallsOrder)
            : base(i_AssetName, i_Game, i_CallsOrder)
        { }

        public SpriteLabel(string i_AssetName, Game i_Game)
        ...
        {
            m_WidthBeforeScale = m_SpriteFont.MeasureString(Text).X;
            m_HeightBeforeScale = m_SpriteFont.MeasureString(Text).Y;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            m_SpriteBatch.DrawString(SpriteFont, Text, PositionForDraw, TintColor, Rotation, RotationOrigin, Scales, SpriteEffects.None, LayerDepth);
